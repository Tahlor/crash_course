const CACHE='amazon-algo-course-v4';
const CORE=['./','./index.html','./style.css','./app.js','./practice.html','./practice.css','./practice.js','./code.html','./code.css','./code.js','./manifest.webmanifest'];
